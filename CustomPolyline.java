...
public class Polyline extends OverlayWithIW {
    ...
    public Polyline() {
        ...
        this.mPaint.setPathEffect(new CornerPathEffect(30));
        this.mPaint.setStrokeWidth(10.0f);
        this.mPaint.setDither(true);                    // set the dither to true
        ...
        this.mPaint.setPathEffect(new CornerPathEffect(10));   // set the path effect when they join.
